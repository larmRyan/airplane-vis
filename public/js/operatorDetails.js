...
OperatorDetails.prototype.update = function() {
    ...
    self.operatorDetailsSvg.selectAll(".operatorDetailsSvg")
        ...
        .on("mouseover", function(d) {
            ...
            var flightNum = element.FlightNum;
            if (flightNum == "") {
                flightNum = "N/A";
            }
            tooltip.html("Operator: " + element.Operator + "<br>" + "Flight #: " + flightNum + "<br>" + "Type: " + element.Type + "<br>" + "Location: " + element.Location + "<br>" + "Aboard: " + element.Aboard + "<br>" + "Fatalities: " + element.Fatalities + "<br>" + "Date: " + element.Date + "<br>" + "Description: " + element.Summary).style("visibility", "visible").style("font-family", "HK Grotesk");
        })
